...
#criterion = C'est la métrique avec laquelle l'arbre de décision sélectionne les caractéristique les plus important de façon récursive --> Coef de Gini
#random_state = On a le même résultat à chaque fois qu'on exécute le modèle
